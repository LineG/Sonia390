...
public class ContactTest {
    ...
    public void contactTest() {
        ...
        ViewInteraction appCompatButton = onView(
                allOf(withId(R.id.add_new_contact), withText("Add new contact"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.add_contact_name),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                0),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("oumar"), closeSoftKeyboard());

        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.add_contact_lastName),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.add_contact_email),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
